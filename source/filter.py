...
if __name__ == "__main__":
	...
	parser.add_argument('-t','--AffinityThreshold', help='affinity prediction threshold', required=True)
	parser.add_argument('-T','--RankThreshold', help='rank threshold', required=True)
